...
Each file has a top-level `cases:` list. Unknown keys are rejected — a typo like `assertion:`
would otherwise produce a case that passes vacuously.
...
otherwise a mistyped path reports success forever. The reason names the cause:
